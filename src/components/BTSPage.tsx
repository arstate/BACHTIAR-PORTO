...
const BTSPage = () => {
  ...
  useEffect(() => {
    ...
    // TODO: Add Behind The Scenes video URLs here
    const btsVideos: string[] = [
      // Add your BTS video URLs here
      ...
      <div className="min-h-screen bg-[#050505] flex items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          <motion.div
            ...
            className="w-24 h-24 md:w-32 md:h-32 mx-auto mb-6 rounded-full border-2 border-amber-500/30 border-t-amber-400"
          />
      ...
      <div className="relative z-10 container mx-auto px-6 py-32">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-[family-name:var(--font-display)] italic font-light mb-4">
            Behind The <span className="font-bold">Scenes</span>
          </h1>
          <p className="text-white/60 text-lg max-w-2xl mx-auto">
            Exclusive look at the creative process and making-of moments
          </p>
        </motion.div>
        ...
        {videos.length === 0 ? (
          ...
          >
            ...
            <p className="text-white/40 text-lg">No behind the scenes content available yet</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {videos.map((url, index) => (
              <motion.div
                ...
                className="aspect-video bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-amber-500/50 transition-colors duration-300"
              >
                <iframe
                  src={url}
